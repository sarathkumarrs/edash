...
from leads.import_views import (
...
urlpatterns = [
    ...
    # CSV import (preview/commit) — before <str:pk>/ so they aren't captured as IDs
    path("import/preview/", LeadImportPreviewView.as_view(), name="lead_import_preview"),
    path("import/commit/", LeadImportCommitView.as_view(), name="lead_import_commit"),
    path(
    ...
    # Interaction (logged contact) edit/delete
    path(
        "interactions/<str:pk>/",
