...
class MultiTenancyBaseTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.org_a = Org.objects.create(name="Organization A", approval_status="approved")
        self.org_b = Org.objects.create(name="Organization B", approval_status="approved")
...
class TestBaseOrgModel(TestCase):
    ...
    def test_org_required_on_save(self):
        ...
        org = Org.objects.create(name="Test Org", approval_status="approved")
