...
<svelte:head>
  <title>Sign in | EdashCRM</title>
  <meta
    name="description"
    content="Sign in or sign up for EdashCRM to manage your contacts, deals, and grow your business."
  />
</svelte:head>
...
<div class="login-page">
  ...
  <div class="login-wrapper">
    ...
    <a href="/" class="logo">
      ...
      <span class="logo-text">EdashCRM</span>
    </a>
