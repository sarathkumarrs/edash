...
<svelte:head>
  <title>Support - EdashCRM</title>
</svelte:head>

<PageHeader
  title="Help & Support"
  subtitle="Join thousands of businesses using EdashCRM to manage customer relationships without the enterprise price tag."
  size="display"
/>
  ...
  <section class="content-area">
    <div class="mission-card glass-card animate-in-up stagger-3">
      ...
      <div class="mission-content">
        <h2>Our Mission</h2>
        <p>
          EdashCRM addresses the high subscription costs of commercial CRM alternatives by
          providing a
    ...
    <div class="bento-grid">
      ...
      <article class="bento-card hover-lift animate-in-up stagger-5">
        ...
        <p>Have an idea? Share your requests and help shape the future of EdashCRM.</p>
        <Button
          variant="outline"
          class="card-action-outline"
          onclick={() =>
        ...
        <Button
          ...
          onclick={() =>
            (window.location.href =
              'mailto:ashwin@micropyramid.com?subject=Security%20Issue%20-%20EdashCRM')}
        >
